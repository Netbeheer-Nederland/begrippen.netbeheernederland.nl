---
title: Externe begrippen
parent: Redacteurs
---

# Externe begrippen

Om bestaande definities uit andere begrippenkaders op te nemen kiezen we voor de **harmonisatiestrategie** voorgeschreven door [NL-SBB (§5.3.1)](https://docs.geostandaarden.nl/nl-sbb/nl-sbb/#harmonisatie). Dit houdt in dat we een eigen begrip opvoeren waarvoor we een harmonisatierelatie (bijv. een [_is exact overeenkomstig_-relatie](https://docs.geostandaarden.nl/nl-sbb/nl-sbb/#dfn-is-exact-overeenkomstig)) opnemen naar het [externe begrip](https://docs.geostandaarden.nl/nl-sbb/nl-sbb/#dfn-extern-begrip).

Deze keuze komt met een aantal significante voordelen:
